...
*Screenshot showcasing the main interface and gesture recognition in action.*
...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/YousefAl-Qahtani/AiBadge-.git
   cd AiBadge-
   ```
...
5. **Prepare Assets**
   ...
   - **Fonts:**
     - Ensure the `Amiri-Bold.ttf` font file is available in your project directory or update the `font_path` in the script to point to a valid font on your system.
   - **Loading Indicator:**
...
You can find the source code and further updates on the [GitHub Repository](https://github.com/YousefAl-Qahtani/AiBadge-).
